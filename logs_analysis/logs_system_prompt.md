...
| | | "ONGOING" (80.4%) | Conversation still in progress |
| | | "AGENT_HANDOVER" (13.0%) | Handed over to human agent |
| | | "RESOLVED" (2.4%) | Successfully resolved |
| | | "UNRESOLVED" (1.8%) | Ended without resolution |
| | | "AUTHORIZATION_REQUIRED" (2.0%) | Requires authorization |
| | | "CALL_HANGUP" (0.2%) | Call was hung up |
| | | "INSUFFICIENT_PERMISSIONS" (0.2%) | Insufficient permissions |
